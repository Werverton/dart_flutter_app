...
class UpcomingSchedule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (carePlanController.itemCarePlanList.isEmpty) {
      return Center(
        child: Text('Sem plano de cuidados ainda.'),
      );
    } else {
    return Padding(
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    subtitle: Obx(
                      () => Text(
                          "Quantidade: ${carePlanController.itemCarePlanList[0].quantidade}"),
                    ),
  ...
  Widget _buildCard(CarePlanController carePlanController, BuildContext context, int index){
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 15),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
